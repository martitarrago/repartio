  ...
  return (
    ...
    >
      ...
      <div className="relative" ref={ref}>
        <button
          onClick={() => setOpen((v) => !v)}
          className="flex h-8 w-8 items-center justify-center rounded-full solar-gradient text-[11px] font-semibold text-white shadow-emerald transition-opacity hover:opacity-90"
        >
          {iniciales}
        </button>
